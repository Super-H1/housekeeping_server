    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_id', models.ForeignKey(db_column='good_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='user.Services')),
            ],
            options={
                'db_table': 'cart',
            },
